...
df<-mutate(df,mapping.perc=100*n.matched/total,coverage.seq=round(n.matched/nrow(analysis.par$raw.count.table)))
kableExtra::kable(df,align = "c") %>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
...
print(paste("Suggested n.mismatch to rescue the most reads is ", n.mismatch[cutoff]))
```
