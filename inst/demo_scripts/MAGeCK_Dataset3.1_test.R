...
demoInput_dir  <- '/home/dongxinran/project/screenBEAM2/dataset/demo/fastq/'
demoOutput_dir <- '/home/dongxinran/project/screenBEAM2/dataset_result/D3.1/MAGeCKFlute/'
if (!file.exists(demoOutput_dir)) dir.create(demoOutput_dir, recursive = TRUE)
project_name <- 'GSC_0131' # patient-derived GBM stem-like cells (GSCs) 
...
org <- 'hsa';case_group <- 'Day0';control_group <- 'Day23'
