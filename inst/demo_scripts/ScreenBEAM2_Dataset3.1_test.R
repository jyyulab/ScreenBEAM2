...
demoOutput_dir <- '/home/dongxinran/project/screenBEAM2/dataset_result/D3.1/screenBEAM2/'
...
analysis.par <- ScreenBEAM.createEset(analysis.par, normalize.total = 1e6, n.mismatch = 3)
...
draw.eset.QC(count.Nmm.normalized.eset, outdir = analysis.par$out.dir.output.QC, intgroup = 'group', 
			do.logtransform = T, prefix = 'norm.3mm_', 
